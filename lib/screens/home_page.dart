...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final dateText = DateFormat('yyyy 年 M 月 d 日 EEEE', 'zh_TW').format(DateTime.now());
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 10),
                      Text(appState.greetingText(), style: Theme.of(context).textTheme.bodyLarge),
                    ],
                  ),
                ),
                              ...
                              children: focusGoals
                                  .map(
                                    (goal) => ListTile(
                                      ...
                                      subtitle: Text('還有 ${goal.daysLeft} 天，進度 ${goal.progress}%'),
                                    ),
                                  )
                                  .toList(),
                            ),
                    ...
                    return SizedBox(
                      ...
                      child: CuteCard(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(DateFormat('M/d E', 'zh_TW').format(date), style: Theme.of(context).textTheme.titleMedium),
                            const SizedBox(height: 10),
