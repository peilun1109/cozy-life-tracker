...
class MobileEntriesScreenV2 extends StatelessWidget {
  const MobileEntriesScreenV2({
    super.key,
  ...
  Future<void> _confirmDelete(BuildContext context, int id, AppState appState) async {
...
Future<void> showEntryEditorSheetV2(
  ...
  await showModalBottomSheet<void>(
    ...
    builder: (context) => _EntryEditorSheetV2(
      appState: appState,
      existing: existing,
    ),
  );
...
class _EntryEditorSheetV2 extends StatefulWidget {
  const _EntryEditorSheetV2({
    required this.appState,
    this.existing,
  });
  ...
  @override
  State<_EntryEditorSheetV2> createState() => _EntryEditorSheetV2State();
}

class _EntryEditorSheetV2State extends State<_EntryEditorSheetV2> {
