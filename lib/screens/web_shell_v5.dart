...
import 'web_home_v4.dart';

class WebShellV5 extends StatefulWidget {
  const WebShellV5({
    super.key,
  ...
  @override
  State<WebShellV5> createState() => _WebShellV5State();
}

class _WebShellV5State extends State<WebShellV5> {
  @override
  void initState() {
    super.initState();
  ...
  Widget _buildBody() {
    switch (widget.appState.selectedSection) {
      case AppSection.home:
        return WebHomeV4(appState: widget.appState);
        ...
        children: [
          ...
          CuteCard(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('一句提醒', style: Theme.of(context).textTheme.titleMedium),
                const SizedBox(height: 8),
                const Text('先把每天過得有感，再來談更遠的目標。'),
              ],
            ),
          ),
        ],
