                  ...
                  itemBuilder: (context, index) {
                    ...
                    return CuteCard(
                      backgroundColor: index.isEven
                          ? AppTheme.mint.withOpacity(0.54)
                          : AppTheme.peach.withOpacity(0.58),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Row(
                          ...
                          Wrap(
                            ...
                            children: [
                              Chip(
                                label: Text('開始 ${DateFormat('yyyy/M/d').format(goal.startDate)}'),
                              ),
                              Chip(
                                label: Text('截止 ${DateFormat('yyyy/M/d').format(goal.endDate)}'),
                              ),
