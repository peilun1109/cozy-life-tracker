...
class WebHomeV5 extends StatefulWidget {
  const WebHomeV5({
    super.key,
  ...
  @override
  State<WebHomeV5> createState() => _WebHomeV5State();
}

class _WebHomeV5State extends State<WebHomeV5> {
  @override
              ...
              Expanded(
                ...
                child: Column(
                  children: [
                    _SectionCard(
                      title: '生活出席小日曆',
                      subtitle: '保留 GitHub 格子感，但改成更柔和的生活版本。',
                    ...
                    _SectionCard(
                      title: '未來一週安排',
                      subtitle: '一週維持一排，每一天都是一張清楚的小卡片。',
                      accentColor: AppTheme.sky,
                      child: LayoutBuilder(
                        builder: (context, constraints) {
                          const gap = 10.0;
                          final cardWidth =
                              ((constraints.maxWidth - gap * 6) / 7).clamp(98.0, 180.0);
              ...
              Expanded(
                ...
                child: Column(
                  children: [
                    _SectionCard(
                      title: '本週焦點',
                      subtitle: '首頁先只留最重要的幾件事，其它內容交給各自頁面。',
                    ...
                    _SectionCard(
                      ...
                      child: recentEntries.isEmpty
                          ? const _EmptyText('還沒有新的紀錄，今天可以先寫下一句話。')
                          : Column(
        ...
        children: [
              ...
              children: [
                Text(
                  ...
                  style: theme.textTheme.bodySmall?.copyWith(
                    color: AppTheme.cocoa.withValues(alpha: 0.72),
            ...
            child: lines.isEmpty
                ? Text(
                    ...
                    style: theme.textTheme.bodyMedium?.copyWith(
                      height: 1.45,
                      color: AppTheme.cocoa.withValues(alpha: 0.76),
                    ),
                  )
                : Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                      ...
                      for (final line in lines.take(2))
                        Padding(
                          ...
                          child: Text(
                            ...
                            style: theme.textTheme.bodyMedium?.copyWith(
                              height: 1.35,
                              color: AppTheme.cocoa.withValues(alpha: 0.86),
                            ),
                          ),
                        ),
                      if (lines.length > 2)
                        Text(
                          ...
                          overflow: TextOverflow.ellipsis,
                          style: theme.textTheme.bodySmall?.copyWith(
                            color: AppTheme.cocoa.withValues(alpha: 0.6),
                            fontWeight: FontWeight.w700,
                          ),
                        ),
                    ],
          ...
          SizedBox(
            ...
            child: FilledButton.tonalIcon(
              onPressed: onAdd,
              icon: Icon(items.isEmpty ? Icons.add_rounded : Icons.edit_rounded, size: 16),
              label: FittedBox(
...
class _HeatmapWeek extends StatelessWidget {
  ...
  Color _heatColor(int count) {
    if (count <= 0) return const Color(0xFFF8EEF2);
    if (count <= 2) return const Color(0xFFF4C9D8);
