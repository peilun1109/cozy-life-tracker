...
class MobileEntriesScreen extends StatelessWidget {
  const MobileEntriesScreen({
    super.key,
  ...
  Widget build(BuildContext context) {
    if (appState.entries.isEmpty) {
      return const Center(child: Text('目前還沒有生活紀錄，先寫下一小段今天吧。'));
    }
          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<String?>(
                ...
                items: [
                  const DropdownMenuItem<String?>(value: null, child: Text('先不選')),
                  ..._moods.map(
              ...
              DropdownButtonFormField<int?>(
                ...
                items: [
                  const DropdownMenuItem<int?>(value: null, child: Text('不關聯')),
